	...
	: Super(ObjectInitializer)
{
	...
	EquipmentManagerComponent = CreateDefaultSubobject<UDungeonRealmsEquipmentManagerComponent>(TEXT("EquipmentManager"));
}
...
void ADungeonRealmsPlayerCharacter::PossessedBy(AController* NewController)
{
	...
	if (HasAuthority())
	{
		for (TSubclassOf EquipmentDefinition : StartupEquipmentClasses)
		{
