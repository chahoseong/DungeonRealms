#include "Equipment/Components/EquipmentComponent_AttachToSocket.h"
#include "Equipment/DungeonRealmsEquipmentInstance.h"
#include "GameFramework/Character.h"

void UEquipmentComponent_AttachToSocket::OnEquipped(UDungeonRealmsEquipmentInstance* EquipmentInstance)
{
...
void UEquipmentComponent_AttachToSocket::OnUnequipped(UDungeonRealmsEquipmentInstance* EquipmentInstance)
{
	if (EquipmentInstance->HasAuthority())
	{
