...
#include "EquipmentComponent_AttachToSocket.generated.h"
...
class DUNGEONREALMS_API UEquipmentComponent_AttachToSocket : public UDungeonRealmsEquipmentComponent
{
	GENERATED_BODY()
