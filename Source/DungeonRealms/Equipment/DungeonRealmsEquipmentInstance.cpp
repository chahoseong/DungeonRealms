...
#include "Components/DungeonRealmsEquipmentComponent.h"
...
{
	for (UDungeonRealmsEquipmentComponent* EquipmentModifier : EquipmentComponents)
	{
		EquipmentModifier->OnEquipped(this);
	}
	K2_OnEquipped();
}
...
void UDungeonRealmsEquipmentInstance::OnUnequipped()
{
	...
	for (UDungeonRealmsEquipmentComponent* EquipmentModifier : EquipmentComponents)
	{
		EquipmentModifier->OnUnequipped(this);
	}
}
